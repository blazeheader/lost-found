...
<html>
<head>
	<title>Report Found Items</title>
...
<body>
<form action="found.php" method="post" onSubmit="return check();" name="form1">
	...
	<div class="container">
        ...
        <div class="clearfix">
            <button type="submit" name="submit" class="form-control">Submit Found Item</button>
...
if(isset($_POST['submit']))
{
    ...
    $qry = "INSERT INTO `lostfound`(`uid`, `location`, `contact`, `category`,`description`,`status`) VALUES ('$uid','$location','$contact','$category','$description','$stat')";
